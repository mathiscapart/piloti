-- AlterTable
ALTER TABLE "Loan" ADD COLUMN "returnWeightKg" REAL;
...
INSERT INTO "new_Category" ("archived", "canDry", "createdAt", "label", "order", "parentSlug", "slug") SELECT "archived", "canDry", "createdAt", "label", "order", "parentSlug", "slug" FROM "Category";
DROP TABLE "Category";
