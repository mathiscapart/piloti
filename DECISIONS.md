...
**Résidu connu** : la page publique du propriétaire n'envoie pas d'empreinte. Si le chef corrige le téléphone sans changer l'email pendant que la page est ouverte, le jeton est conservé (amendement #137). Le propriétaire accepte alors un contact dont il a vu l'ancienne version. Le correctif serait la même empreinte sur la page publique, et il sort du périmètre de #151.
