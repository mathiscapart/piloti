...
- Toute nouvelle clé de `metadata` d'audit non personnelle doit être ajoutée à la liste blanche, sinon elle disparaît à l'anonymisation. Le défaut est donc protecteur.
